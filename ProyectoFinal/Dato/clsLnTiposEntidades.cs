...
public class clsLnTiposEntidades {
	...
	public void Cargar(ref clsBeTbUsuarios oBeTiposEntidades, ref DataRow dr) {
		try {
				...
				oBeTiposEntidades.TEDescripcion = ( IsDBNull(dr.Item['TEDescripcion']) ? '' : dr.Item['TEDescripcion'] )
				...
				oBeTiposEntidades.Estatus = ( IsDBNull(dr.Item['Estatus']) ? '' : dr.Item['Estatus'] )
	...
	public int Insertar(ref clsBeTiposEntidades oBeTiposEntidades) {
		try {
			...
			cmd.Parameters.Add(new SqlClient.SqlParameter("@TEDESCRIPCION", oBeTiposEntidades.TEDescripcion));
			...
			cmd.Parameters.Add(new SqlClient.SqlParameter("@ESTATUS", oBeTiposEntidades.Estatus));
