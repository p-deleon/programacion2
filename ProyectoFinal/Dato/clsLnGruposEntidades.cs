...
public class clsLnGruposEntidades {
	...
	public void Cargar(ref clsBeTbUsuarios oBeGruposEntidades, ref DataRow dr) {
		try {
				oBeGruposEntidades.IdGrupoEntidad = ( DBNull(dr.Item['IdGrupoEntidad']) ? 0 : dr.Item['IdGrupoEntidad'] )
				oBeGruposEntidades.DEDescripcion = ( IsDBNull(dr.Item['DEDescripcion']) ? '' : dr.Item['DEDescripcion'] )
				oBeGruposEntidades.Comentario = ( IsDBNull(dr.Item['Comentario']) ? '' : dr.Item['Comentario'] )
				oBeGruposEntidades.Estatus = ( IsDBNull(dr.Item['Estatus']) ? '' : dr.Item['Estatus'] )
	...
	public int Insertar(ref clsBeGruposEntidades oBeGruposEntidades) {
		try {
			...
			cmd.Parameters.Add(new SqlClient.SqlParameter("@DEDESCRIPCION", oBeGruposEntidades.DEDescripcion));
			cmd.Parameters.Add(new SqlClient.SqlParameter("@COMENTARIO", oBeGruposEntidades.Comentario));
			cmd.Parameters.Add(new SqlClient.SqlParameter("@ESTATUS", oBeGruposEntidades.Estatus));
